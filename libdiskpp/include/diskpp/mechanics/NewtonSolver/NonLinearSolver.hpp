...
template <typename Mesh> class NonLinearSolver {
    ...
    void init_degree(const size_t cell_degree, const size_t face_degree, const size_t grad_degree) {
  ...
  public:
    ...
    template <typename LoadFunction> SolverInfo compute(const LoadFunction &lf) {
        // Precomputation
