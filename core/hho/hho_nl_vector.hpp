                                 ...
                                 const std::vector<vector_type>& sol_lagr, const std::vector<size_t>& boundary_neumann)
      {
         ...
         for (auto itor = msh.boundary_faces_begin(); itor != msh.boundary_faces_end(); itor++)
         {
               ...
               != boundary_neumann.end() )
            {
               ...
               rhs_f = -sol_lagr.at(face_i);
            
               matrix_type I = matrix_type::Zero(fbs, fbs);
...
//                      m_triplets.push_back( triplet_type(face_offset_lagrange + i, face_offset_lagrange + j, I(i,j)) );
//                   }
...
//                   {
//                      m_triplets.push_back( triplet_type(face_offset + i, face_offset_lagrange + j, MFF(i,j)) );
//                      m_triplets.push_back( triplet_type(face_offset_lagrange + j, face_offset_lagrange + j, I(i,j)) );
//                   }
