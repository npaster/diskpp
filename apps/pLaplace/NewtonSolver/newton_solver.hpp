...
class NewtonRaphson_solver_pLaplace
{
...
public:
   NewtonRaphson_solver_pLaplace(const mesh_type& msh, const size_t degree, const pLaplaceParameters lap_param, int l = 0)
            ...
            const std::size_t iter_max = 50)
   {
      ...
      NewtonRaphson_step_pLaplace<Mesh> newton_step(m_msh, m_degree, m_lap_param, 0);
