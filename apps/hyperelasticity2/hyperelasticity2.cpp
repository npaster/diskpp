...
void
run_hyperelasticity2_solver(const Mesh<T, 2, Storage>& msh, ParamRun<T>& rp, const ElasticityParameters& elas_param)
{
...
template<template<typename, size_t, typename> class Mesh,
         typename T, typename Storage>
void
run_hyperelasticity2_solver(const Mesh<T, 3, Storage>& msh, ParamRun<T>& rp, const ElasticityParameters elas_param)
{
