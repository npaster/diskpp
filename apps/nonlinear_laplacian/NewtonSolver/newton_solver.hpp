...
class NewtonRaphson_solver_laplacian
{
...
public:
   NewtonRaphson_solver_laplacian(const mesh_type& msh, size_t degree, int l = 0)
            ...
            const std::size_t iter_max = 30, const std::size_t reac_iter=1)
   {
      ...
      NewtonRaphson_step_laplacian<Mesh> newton_step(m_msh, m_degree, 0);
