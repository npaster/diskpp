...
public:
    NewtonRaphson_step(const mesh_type& msh, size_t degree, int l = 0)
    ...
    {
      // a calculer erreur
      scalar_type relative_error(100.);
      scalar_type max_error(200.);

      if(iter == 0){
         std::cout << "----------------------------------------------" << std::endl;
         std::cout << "| Iteration | Relative error | Maximum error |" << std::endl;
         std::cout << "----------------------------------------------" << std::endl;
         std::cout << "| " << iter << " | " << relative_error << " | " << max_error << " |" << std::endl;
         std::cout << "----------------------------------------------" << std::endl;
      }
      else {
         std::cout << "| " << iter << " | " << relative_error << " | " << max_error << " |" << std::endl;
