...
public:
   CH_mixte_solver(const mesh_type& msh, size_t degree, int l = 0)
   ...
   compute_offline()
   {
      disk::gradient_reconstruction< mesh_type,
                                          ...
                                          face_basis_type, face_quadrature_type> gradrec(m_degree);
...
//      }
      ...
      size_t n_time_step = 1)
   {
      ...
      NewtonRaphson_solver_CH<Mesh<T,DIM,Storage>> newton_solver(m_msh, m_degree, 0);
